...
//here we define the password generator component
function PwdGen(){
           ...
           <span className="w-full flex flex-row justify-center items-center">
            ...
            <span className=" text-green-400 flex items-center justify-around px-1 w-full flex-wrap">
                ...
                <span className="flex flex-nowrap items-center justify-center whitespace-nowrap">
                    ...
                    <input className="overflow-visible h-1 rounded-l"
                    type="range" 
                    min={6} 
                    max={100} 
                    value={pwdLen} 
                    ...
                    <input className="ml-1 bg-transparent w-11 pr-2 text-center focus:outline-green-500 appearance-none"
                    type="text" 
                    value={pwdLen} 
